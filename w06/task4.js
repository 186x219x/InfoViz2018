...
function main()
{
    ...
    p1.innerHTML = "These two are using Cook-Torrance reflection."
    +"<br>"
    ...
    var material_Gouraud_Blinn_Phong = new THREE.ShaderMaterial({
      ...
      vertexShader: document.getElementById('Gouraud_Cook_Torrance.vert').text,
      fragmentShader:document.getElementById('Gouraud_Cook_Torrance.frag').text
    });


    var material_Phong_Blinn_Phong = new THREE.ShaderMaterial({
      vertexColors: THREE.VertexColors,
      vertexShader: document.getElementById('Phong_Cook_Torrance.vert').text,
      fragmentShader:document.getElementById('Phong_Cook_Torrance.frag').text
    });
