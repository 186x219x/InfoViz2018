function Isosurfaces( volume, isovalue )
{
    ...
    function interpolated_vertex( v0, v1, s )
    {
      var i0 = v0.x;
      var i1 = v1.x;
      var lines0 = v0.y*volume.resolution.x;
      var slices0 = v0.z*volume.resolution.x * volume.resolution.y;
      var lines1 = v1.y*volume.resolution.x;
      var slices1 = v1.z*volume.resolution.x * volume.resolution.y;
      var id0 = i0 + lines0 + slices0;
      var id1 = i1 + lines1 + slices1;
